    ...
    <div>
      ...
      <div className="content-container">
        ...
        <div className="team-container">
          <div className="box">
            <div className="imgBx">
              <img src={manoharaImage} alt="Director : Mr. Manohara" />
            </div>
            <div className="content">
              <h2>
                ...
                <span>
                  Director
                  <br />
                  📱 <a href="tel:+94773088508">+94 77 308 8508</a>
                  <br />
                  📧{" "}
          ...
          <div className="box">
            <div className="imgBx">
              <img src={jayaruwanImage} alt="Director : Mr. Jayaruwan" />
            </div>
            <div className="content">
              <h2>
                D P I Jayaruwan
                ...
                <span>
                  Director
                  <br />
                  📱 <a href="tel:+94772386944">+94 77 238 6944</a>
                  <br />
                  📧{" "}
            ...
            <div className="content">
              <h2>
                ...
                <span>
                  Director
                  <br />
                  📱 <a href="tel:+94764160217">+94 76 416 0217</a>
                  <br />
                  📧{" "}
            ...
            <div className="content">
              <h2>
                ...
                <span>
                  Director
                  <br />
                  📱 <a href="tel:+94769752104">+94 76 975 2104</a>
                  <br />
                  📧{" "}
          ...
          <div className="box">
            <div className="imgBx">
              <img src={trimavithanaImage} alt="Director : Mr. Trimavithana" />
            </div>
            <div className="content">
              <h2>
                C W Trimavithana
                ...
                <span>
                  Director
                  <br />
                  📱 <a href="tel:+94775131830">+94 77 513 1830</a>
                  <br />
                  📧{" "}
